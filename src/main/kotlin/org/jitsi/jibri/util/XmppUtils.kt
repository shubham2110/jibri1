 ...
 */
fun getCallUrlInfoFromJid2(roomJid: EntityBareJid, stripFromRoomDomain: String, xmppDomain: String, xmppServer : String): CallUrlInfo {
    try {
        ...
        return when {
            subdomain.isEmpty() -> CallUrlInfo("https://$xmppServer", callName)
            else -> CallUrlInfo("https://$xmppServer/$subdomain", callName)
        }
    } catch (e: Exception) {
